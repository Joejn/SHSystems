...
Item {
    ...
    Button {
        ...
        onClicked: {
            ...
            var data = "r;" + mode + ";" + colorR + ";" + colorG + ";" + colorB + ";";
    ...
    CheckBox {
        ...
        x: 1368
        y: 1000
        text: qsTr("Zurücklaufen")
        scale: 1
        anchors.right: button_execute.left
        anchors.rightMargin: 40
        anchors.verticalCenter: button_execute.verticalCenter
        font.pointSize: 16
    }
...
/*##^##
Designer {
    D{i:0;formeditorZoom:0.5}D{i:1;anchors_width:295;anchors_x:68;anchors_y:107}D{i:2;anchors_height:581;anchors_width:343;anchors_x:1494;anchors_y:146}
D{i:3;anchors_width:295;anchors_x:68;anchors_y:185}D{i:4;anchors_width:295;anchors_x:68;anchors_y:283}
}
##^##*/
